package com.phaggu.filetracker.barcodescanner
...
import com.phaggu.filetracker.databinding.FragmentBarcodeScannerBinding
...
class BarcodeScannerFragment: Fragment(), AddNewFileDialogFragment.NoticeDialogListener {
    ...
    override fun onDialogNegativeClick(dialog: DialogFragment) {
        ...
        this.findNavController().navigate(
                BarcodeScannerFragmentDirections.actionBarcodeScannerFragmentToMainFragment()
        )
    }
